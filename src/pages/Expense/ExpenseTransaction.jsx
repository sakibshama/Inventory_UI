...
const ExpenseTransaction = () => {
    ...
    const expenseTransactionId = useSelector((state) => state.expenses.expenseTransactionId);
    ...
    const handleSubmit = () => {
        ...
        console.log(expenseTransactionId);
        


        payments.forEach((payment) => {
            let transactionData = {...payment,expense_id:expenseTransactionId, transaction_type:"out"};
