...
const API_URL = `${import.meta.env.VITE_BASE_URL}/api/brands`;
...
export const updateBrand = createAsyncThunk(
  ...
  async ({ id, updatedData }, thunkAPI) => {
    try {
      ...
      return response.data; // Assuming response.data.brand contains the updated brand
    } catch (error) {
...
const brandSlice = createSlice({
  ...
  initialState,
  reducers: {
    setBrandIdz:(state,action)=>{
      state.setBrandId=action.payload;
    }
  },
...
// Export the reducer
export const  {setBrandIdz} = brandSlice.actions;
